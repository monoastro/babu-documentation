...
def build_citizenship(data: dict[str, Any]) -> Document:
    ...
    data_section = FieldGroup(
        multi_row(
            field_row("Full Name:", d["full_name"], field_name="full_name"),
            field_row("Gender:", d["gender"], label_style=RIGHT_LABEL, field_name="gender"),
        ),
        multi_row(
            LabelValue(
                "Birth Place:",
            ...
            field_row("Ward No.:", d["birth_ward"], label_style=RIGHT_LABEL, field_name="birth_ward"),
        ),
        multi_row(
            LabelValue(
                "Permanent Address:",
            ...
            field_row("Ward No.:", d["perm_ward"], label_style=RIGHT_LABEL, field_name="perm_ward"),
        ),
        multi_row(
            LabelValue(
                "Date of Birth:",
