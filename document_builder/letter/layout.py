...
def build_letter(data: dict[str, Any]) -> Document:
    ...
    doc.add(
        FlexRow(
            Div(
                Heading("त्रिभुवन विश्वविद्यालय", level=2, style=Style(color="#2d55ae", font_size="19px", margin_bottom="0")),
                Heading("Tribhuvan University", level=5, style=Style(font_size="13px", color="#2d55ae",margin="-2px 0 0 0")),
                style=Style(text_align="left", flex="1", padding_left="14px"),
            ),
            Div(
                Heading("Ph. No. +977-014244047", level=5, style=Style(font_weight="normal", font_size="13px", color="#e02922", text_align="right")),
    ...
    doc.add(
        FlexCol(
            Heading("त्रि–चन्द्र बहुमुखी क्याम्पस", level=1, style=Style(font_size="30px", color="#e02922", margin_bottom="0", font_weight="bold")),
            Heading("Tri-Chandra Multiple Campus", level=2, style=Style(font_size="20px", color="#2d55ae", font_weight="bold", margin="-2px 0 2px 0")),
    ...
    doc.add(
        AbsoluteBox(
            ...
            style=Style(
                width="110px", height="110px", border="2px solid #6e74aa",
    ...
    doc.add(
        FlexRow(
            Div(
                Text("क्याम्पस प्रमुखको कार्यालय", style=Style(color="#e02922", font_weight="bold", font_size="12.5px")),
                RawHTML("<br>"),
                Text("Office of the Campus Chief", style=Style(color="#68225a", font_size="12px")),
                RawHTML("<br>"),
    ...
    # Subject
    doc.add(
        Heading("Subject:", level=4, style=Style(font_size="18px", margin="5px 0 0 0", color="#344")),
    )
    doc.add(
    ...
    doc.add(
        FlexRow(
            ...
            FlexCol(
                Spacer(height="70px"),
                Text(d["signature_placeholder"], attrs=_ea("signature_placeholder"), style=Style(font_size="15px", border="1.8px dashed #4a90d9", padding="6px 13px", margin_bottom="6px")),
                Text(d["signed_name"], attrs=_ea("signed_name"), style=Style(font_weight="bold", font_size="18px", margin_bottom="2px")),
                Text(d["position"], attrs=_ea("position"), style=Style(font_size="16px", color="#063c72")),
    ...
    # बोधार्थ:/CC list
    doc.add(
        Heading("बोधार्थ:", level=4, style=Style(font_size="18px", color="#273b67", margin_top="7px")),
    )
