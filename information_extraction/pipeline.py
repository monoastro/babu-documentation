...
def build_document(document_type, image_path, translate = True):
...
def digitize_document(document_type, image_path, output_path = "output.html", translate = True):
    doc = build_document( document_type, image_path, translate=translate,)
